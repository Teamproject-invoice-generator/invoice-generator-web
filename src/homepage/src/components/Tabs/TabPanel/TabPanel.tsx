    ...
    >
      ...
      <div className="text-center md:flex md:flex-col md:gap-[1.5625rem] md:text-left lg:pt-[3.25rem] lg:pl-[4.5rem]">
        ...
        <div className="">
          <a
            href="#"
            className="mx-auto mt-[0.5rem] block w-max rounded-md border-[0.188rem] border-blue-500 bg-soft-blue py-[0.6558rem] px-[1.437rem] text-[0.875rem] font-bold text-blue-500 transition duration-300 hover:bg-white hover:text-soft-blue md:mx-0"
          >
            More info
          </a>
        </div>
